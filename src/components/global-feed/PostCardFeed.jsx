        ...
        <section>
          <div className="my-[0.5rem] grid grid-cols-12 items-center">
            ...
            <div className="col-span-8 text-md flex flex-col justify-center pixel-text">
              ...
              <i className="text-gray-400 text-[0.65rem]">
                &bull;{" "}
            ...
            <div className="col-span-1 flex flex-col justify-center items-end text-[0.8rem] md:text-[1rem]">
              {amOnProfile && (
                <button
                  ...
                  className=" p-2 px-3 w-[50px] bg-red-400 rounded-[5px] pixel-text flex flex-col justify-center items-center"
                >
        ...
        <section className="mt-[20px] mb-[10px] w-full pixel-text">
          <div className="flex flex-row gap-6">
            ...
            >
              <figure>
                <img
                  src={likedState ? "/heart-solid.svg" : "/heart-regular.svg"}
                  width="25px"
                  alt="Heart Icon"
                />
              </figure>
            ...
            <div className="flex flex-col">
              <Link
                href={{ pathname: "/post-card", query: { postId: post.id } }}
              >
                <button>
                  <figure>
                    <img
